...
export default class Title extends Phaser.State {
    ...
    public create(): void {
        // this.heroImage = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY + 17, Assets.Atlases.GraphicsHeroIdle.getName());

        // this.blackCell = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, Assets.Images.ImagesBackgroundTemplate.getName());
